...
// El catálogo y su filtro viven en ./badgesCatalogo (módulo puro, sin supabase
// detrás) para que se puedan probar. Se reexportan desde aquí porque es donde
// los buscan las pantallas.
export { BADGES, insigniasDisponibles } from './badgesCatalogo';
export type { BadgeId } from './badgesCatalogo';
import { BADGES, type BadgeId } from './badgesCatalogo';
